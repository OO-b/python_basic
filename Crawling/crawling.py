...
f.write("[inverter]\n")
f.write("현재="+currentPower+"\n")
f.write("금일="+todayPower+"\n")
f.write("전일="+previosDayPower+"\n")
f.write("누적="+accumulatePower+"\n")
f.write("금일CO2="+currentCo2Power+"\n")
f.write("누적CO2="+accumulateCo2Power+"\n")
f.write("인버터="+str(inverterstatus)+"\n")
f.write("웹접속=1")
f.close()
